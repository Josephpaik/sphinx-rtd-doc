...
|image1|\ |image2|\ |image3|\ |image4|\ 1. **REPORTS > Database > 사용자
순위**\ 를 클릭합니다.

|image5|\ 2. 사용자 순위 필터에서 버튼을 클릭하고 아래 **패턴 이름**\ 과
**순위 선정 기준**\ 을 선택한 후

   |image6| 을 클릭합니다. (\* 아래 이미지는 *‘패턴 개수’를 순위 선정
   기준*\ 으로 선택한 경우입니다.)
...
|image7|\ 3. 다음은 *(매칭된 패턴 수를 기준으로) 주민등록번호를 가장
많이 조회한 사용자*\ 에 대한 검색결과입니다.
